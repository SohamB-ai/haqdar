    ...
    <div style={styles.dashboard}>
      ...
      <header style={styles.header}>
        ...
        <div style={styles.headerCenter}>
          <span style={{ color: '#40E0D0' }}>Maharashtra</span>
          <ArrowRight size={20} style={{ color: '#40E0D0', margin: '0 1rem' }} />
          <span style={{ color: '#40E0D0' }}>Goa</span>
        </div>
            ...
            <div style={styles.filterList}>
              {['All', ...comparisonData.categories].map(cat => (
                ...
                >
                  <div style={{
                    ...styles.checkbox,
                    background: selectedCategory === cat ? '#40E0D0' : 'transparent',
                    borderColor: '#40E0D0'
                  }} />
                  {cat}
                </div>
        ...
        <main style={styles.content}>
          ...
          <div style={styles.summaryBar}>
            <div style={styles.modeToggle}>
              <span
                style={{ ...styles.modeBtn, color: compareMode === 'Category' ? '#D4AF37' : '#fff' }}
                onClick={() => setCompareMode('Category')}
              >Compare by Category</span>
              <span
                style={{ ...styles.modeBtn, color: compareMode === 'Eligibility' ? '#D4AF37' : '#fff' }}
